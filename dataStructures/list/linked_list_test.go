...
func TestLinkedList_Add(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			newVal:  100,
			index:   -1,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 3, -1),
		},
		{
			...
			newVal:  100,
			index:   4,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 3, 4),
		},
		{
...
func TestLinkedList_Delete(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			list:    NewLinkedListOf[int]([]int{1, 2, 3}),
			index:   99,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 3, 99),
		},
		{
			name:    "delete beyond length index 3",
			list:    NewLinkedListOf[int]([]int{1, 2, 3}),
			index:   3,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 3, 3),
		},
		{
			name:    "delete empty node",
			list:    NewLinkedListOf[int]([]int{}),
			index:   3,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 0, 3),
		},
		{
...
func TestLinkedList_Get(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			list:    NewLinkedListOf([]int{1, 2, 3, 4, 5}),
			index:   -1,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 5, -1),
		},
		{
			name:    "over right",
			list:    NewLinkedListOf([]int{1, 2, 3, 4, 5}),
			index:   5,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 5, 5),
		},
		{
			name:    "empty list",
			list:    NewLinkedListOf([]int{}),
			index:   0,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 0, 0),
		},
	}
...
func TestLinkedList_Set(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			index:   7,
			setVal:  888,
			wantErr: fmt.Errorf("ggu: 下标超出范围，长度 %d, 下标 %d", 7, 7),
		},
		{
			name:    "len(*node) == 0",
			list:    NewLinkedListOf[int]([]int{}),
